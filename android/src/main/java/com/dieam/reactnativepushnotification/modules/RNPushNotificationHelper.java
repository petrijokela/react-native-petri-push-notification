    ...
    public void sendToNotificationCentreWithPicture(Bundle bundle, Bitmap largeIconBitmap, Bitmap bigPictureBitmap, Bitmap bigLargeIconBitmap) {
        try {
            ...
            NotificationCompat.Builder notification = new NotificationCompat.Builder(context, channel_id)
                    .setContentTitle(HtmlCompat.fromHtml(title, 
                        HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS | HtmlCompat.FROM_HTML_MODE_LEGACY))
            ...
            notification.setContentText(HtmlCompat.fromHtml(message, 
                HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS | HtmlCompat.FROM_HTML_MODE_LEGACY));
